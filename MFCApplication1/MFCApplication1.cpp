...
BEGIN_MESSAGE_MAP(CMfcWinDriver, CWinApp)
...
// 僅有的一個 CMfcWinDriver 物件

CMfcWinDriver theApp;


// CMfcWinDriver 初始設定

BOOL CMfcWinDriver::InitInstance()
{
